...
/*
Умова:
Будемо називати натуральне число трипростим, якщо в ньому будь-які 3 цифри, що йдуть підряд, 
утворюють тризначне просте число.
...
Вихідні дані
Вихідний файл OUTPUT.TXT повинен містити кількість N-значних трипростих чисел, яку слід вивести за модулем 10^9+9.
 */
